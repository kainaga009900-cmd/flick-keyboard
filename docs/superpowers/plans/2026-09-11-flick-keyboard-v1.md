...
| # | 試すこと | うまくいった状態 |
|---|---|---|
| 1 | LINE で「かいぎ」と打つ | 太い段に 会議・懐疑 などが出る。細い段は予測があるときだけ最大3つ（空のことも多い）。読みの違う言葉は出ない |
...
| 9 | LINE で「かいぎ」と打った途中で送信ボタンを押し、続けて「あ」と打つ | 送った文の後に「かいぎ」が残らず、「あ」だけが出る |
| 10 | 「かいぎ」と打った途中で、同じ入力欄の別の場所をタップしてから「あ」と打つ | 文字が二重にならない（なったらスクショを送る：対応は Task 10 で決める） |
| 11 | 設定アプリの「ライセンス」を開く | ライセンスの文章が表示される |
